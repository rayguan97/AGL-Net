...
from ..dataset import MapLocDataset, MapLocOriLidarDataset
...
class KittiLidarModule(pl.LightningDataModule):
    default_cfg = {
        **MapLocOriLidarDataset.default_cfg,
        "name": "kitti_lidar",
        # paths and fetch
