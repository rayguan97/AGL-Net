...
from .viz import plot_example_single, plot_example_sequential, plot_example_single_rgb
...
def evaluate_single_image_rgb(
    ...
    ppm = model.model.conf.pixel_per_meter
    metrics = MetricCollection(model.model.metrics())
    metrics["directional_error"] = LateralLongitudinalError(ppm, "uv_max", "uv_gt", "theta_gt")
    metrics = metrics.to(model.device)
    ...
    **kwargs,
    ...
    if output_dir is not None:
        ...
        if callback is None:
            ...
            callback = plot_example_single_rgb
    ...
    metrics = evaluate_single_image_rgb(loader, model, **kwargs)
